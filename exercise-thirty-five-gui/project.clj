(defproject exercise-thirty-five-gui "0.1.0-SNAPSHOT"
  ...
  :aliases {"descjop-help" ["new" "descjop" "help"]
            ...
            "descjop-uberapp-osx" ["shell" "electron-packager" "./app/prod" "exercise-thirty-five-gui" "--platform=darwin" "--arch=x64" "--electron-version=1.6.6"]
            "descjop-uberapp-app-store" ["shell" "electron-packager" "./app/prod" "exercise-thirty-five-gui" "--platform=mas" "--arch=x64" "--electron-version=1.6.6"]
            "descjop-uberapp-linux" ["shell" "electron-packager" "./app/prod" "exercise-thirty-five-gui" "--platform=linux" "--arch=x64" "--electron-version=1.6.6"]
            "descjop-uberapp-win64" ["shell" "cmd.exe" "/c" "electron-packager" "./app/prod" "exercise-thirty-five-gui" "--platform=win32" "--arch=x64" "--electron-version=1.6.6"]
            "descjop-uberapp-win32" ["shell" "cmd.exe" "/c" "electron-packager" "./app/prod" "exercise-thirty-five-gui" "--platform=win32" "--arch=ia32" "--electron-version=1.6.6"]
            }
  :cljsbuild {:builds {:dev-main {:source-paths ["src"]
                                  ...
                                  :compiler {:output-to "app/dev/js/cljsbuild-main.js"
                                             ...
                                             :pretty-print true
                                             :output-wrapper true}}
                       :dev-front {:source-paths ["src_front" "src_front_profile/exercise_thirty_five_gui_front/dev"]
                                   :incremental true
                                   :jar true
                                   :assert true
                       ...
                       :prod-main {:source-paths ["src"]
                                   ...
                                   :compiler {:output-to "app/prod/js/cljsbuild-main.js"
                                              ...
                                              :pretty-print true
                                              :output-wrapper true}}
                       :prod-front {:source-paths ["src_front" "src_front_profile/exercise_thirty_five_gui_front/prod"]
                                    :incremental true
                                    :jar true
                                    :assert true
